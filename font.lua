...
local function RestyleFont(fontObj, fontPath, fontSize, fontFlag, fontColor, fontShadow)
	fontObj:SetFont(fontPath, fontSize, fontFlag and 'OUTLINEMONOCHROME' or '')
...
RestyleFont(SystemFont_Tiny2, 					C.font.normal, 11, true)
RestyleFont(SystemFont_Tiny, 					C.font.normal, 11, true)
RestyleFont(SystemFont_Shadow_Small, 			C.font.normal, 12, true, nil, true)
RestyleFont(Game10Font_o1, 						C.font.normal, 12, true)
RestyleFont(SystemFont_Small, 					C.font.normal, 11, true)
RestyleFont(SystemFont_Small2, 					C.font.normal, 12, true)
RestyleFont(SystemFont_Shadow_Small2, 			C.font.normal, 12, true, nil, true)
RestyleFont(SystemFont_Shadow_Med1_Outline, 	C.font.normal, 12, true)
RestyleFont(SystemFont_Shadow_Med1, 			C.font.normal, 12, true, nil, true)
RestyleFont(SystemFont_Med2, 					C.font.normal, 12, true, nil, true)
RestyleFont(SystemFont_Med3, 					C.font.normal, 12, true, nil, true)
RestyleFont(SystemFont_Shadow_Med3, 			C.font.normal, 12, true, nil, true)
RestyleFont(QuestFont_Large, 					C.font.header, 16, true, nil, true)
RestyleFont(QuestFont_Huge, 					C.font.header, 20, false, nil, true)
RestyleFont(SystemFont_Large, 					C.font.normal, 16, true, nil, true)
RestyleFont(SystemFont_Shadow_Large_Outline, 	C.font.normal, 16, true)
RestyleFont(SystemFont_Shadow_Med2, 			C.font.normal, 16, true, nil, true)
RestyleFont(SystemFont_Shadow_Large, 			C.font.normal, 16, true, nil, true)
...
RestyleFont(SystemFont_Shadow_Outline_Huge2, 	C.font.header, 22, false, nil, true)
RestyleFont(SystemFont_Med1, 					C.font.normal, 12, true)
...
RestyleFont(System_IME, 						C.font.chat, 14, true, nil, true)
...
RestyleFont(ChatFontNormal, 					C.font.chat, 14, true, nil, true)
RestyleFont(ChatFontSmall, 						C.font.chat,12, true, nil, true)
RestyleFont(Game30Font, 						C.font.header, 30, false, nil, {0, 0, 0, 1, 2, -2})

RestyleFont(GameTooltipHeader, 					C.font.normal, 14, true, nil, true)
RestyleFont(Tooltip_Med, 						C.font.normal, 12, true, nil, true)
RestyleFont(Tooltip_Small, 						C.font.normal, 12, true, nil, true)
...
RestyleFont(ErrorFont, 							C.font.normal, 14, true, nil, {0, 0, 0, 1, 2, -2})
...
RestyleFont(FriendsFont_Normal, C.font.normal, 12, true, nil, true)
RestyleFont(FriendsFont_Small, C.font.normal, 12, true, nil, true)
RestyleFont(FriendsFont_Large, C.font.normal, 14, true, nil, true)
RestyleFont(FriendsFont_UserText, C.font.normal, 12, true, nil, true)

RestyleFont(QuestFont, C.font.normal, 14, true, nil, true)
RestyleFont(QuestFontNormalSmall, C.font.normal, 14, true, nil, true)
